      ...
      <div className='flex justify-center'>
        <div
          className={`inline-flex ${
            pagePopulated ? 'invisible h-0' : 'visible px-3 py-2 m-6 rounded-md border'
          } items-center justify-center text-md text-center`}
        >
          <p>
            Search for an artist to find their upcoming gigs! <br /> You can also add a city to narrow down the search.
          </p>
        </div>
      </div>
